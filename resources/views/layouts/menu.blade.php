    ...
    @can('notifications.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('notifications*') ? 'active' : '' }}" href="{!! route('notifications.index') !!}">@if($icons)
                ...
                @endif<p>{{trans('lang.notification_plural')}}</p></a>
        </li>
    @endcan
    @can('favorites.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('favorites*') ? 'active' : '' }}" href="{!! route('favorites.index') !!}">@if($icons)
                ...
                @endif<p>{{trans('lang.favorite_plural')}}</p></a>
        </li>
    @endcan
@endif
            ...
            @can('eProviderTypes.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('eProviderTypes*') ? 'active' : '' }}" href="{!! route('eProviderTypes.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.e_provider_type_plural')}}</p></a>
                </li>
            @endcan
            <li class="nav-item">
                <a class="nav-link {{ Request::is('eProviders*') ? 'active' : '' }}" href="{!! route('eProviders.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-list-alt"></i>
                    @endif<p>{{trans('lang.e_provider_plural')}}</p></a>
            </li>
            ...
            @can('galleries.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('galleries*') ? 'active' : '' }}" href="{!! route('galleries.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.gallery_plural')}}</p></a>
                </li>
            @endcan
            @can('awards.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('awards*') ? 'active' : '' }}" href="{!! route('awards.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.award_plural')}}</p></a>
                </li>
            @endcan
            ...
            @can('experiences.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('experiences*') ? 'active' : '' }}" href="{!! route('experiences.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.experience_plural')}}</p></a>
                </li>
            @endcan
            @can('availabilityHours.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('availabilityHours*') ? 'active' : '' }}" href="{!! route('availabilityHours.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.availability_hour_plural')}}</p></a>
                </li>
            @endcan
            @can('addresses.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('addresses*') ? 'active' : '' }}" href="{!! route('addresses.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.address_plural')}}</p></a>
                </li>
            @endcan
        </ul>
    </li>
...
@can('categories.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('categories*') ? 'active' : '' }}" href="{!! route('categories.index') !!}">@if($icons)
            ...
            @endif<p>{{trans('lang.category_plural')}}</p></a>
    </li>
@endcan
            ...
            @can('optionGroups.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('optionGroups*') ? 'active' : '' }}" href="{!! route('optionGroups.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.option_group_plural')}}</p></a>
                </li>
            @endcan
            @can('options.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('options*') ? 'active' : '' }}" href="{!! route('options.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.option_plural')}}</p></a>
                </li>
            @endcan
            ...
            @can('eServiceReviews.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('eServiceReviews*') ? 'active' : '' }}" href="{!! route('eServiceReviews.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.e_service_review_plural')}}</p></a>
                </li>
            @endcan
...
{{--@can('bookings.index')--}}
<li class="nav-item has-treeview {{ Request::is('bookings*') || Request::is('bookingStatuses*') ? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('bookings*') || Request::is('bookingStatuses*')? 'active' : '' }}"> @if($icons)
        ...
        @can('bookings.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('bookings*') ? 'active' : '' }}" href="{!! route('bookings.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-calendar-check"></i>
                    @endif<p>{{trans('lang.booking_plural')}}</p></a>
            </li>
        @endcan
        @can('bookingStatuses.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('bookingStatuses*') ? 'active' : '' }}" href="{!! route('bookingStatuses.index') !!}">@if($icons)
                    ...
                    @endif<p>{{trans('lang.booking_status_plural')}}</p></a>
            </li>
        @endcan
...
@can('coupons.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('coupons*') ? 'active' : '' }}" href="{!! route('coupons.index') !!}">@if($icons)
            ...
            @endif<p>{{trans('lang.coupon_plural')}} </p></a>
    </li>
@endcan
@can('faqs.index')
            ...
            @can('faqCategories.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('faqCategories*') ? 'active' : '' }}" href="{!! route('faqCategories.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-folder-open"></i>
                        @endif<p>{{trans('lang.faq_category_plural')}}</p></a>
                </li>
            @endcan
...
@if(Module::isActivated('Shop'))
    ...
    @endcan
    @can('stores.index')
        <li class="nav-item has-treeview {{ Request::is('shop/store*','shop/*Stores*','shop/addresses*')  ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ Request::is('shop/store*','shop/*Stores*','shop/addresses*') ? 'active' : '' }}"> @if($icons) <i class="nav-icon fas fa-shopping-bag"></i>@endif
                <p>{{trans('shop::lang.store_plural')}} <i class="right fas fa-angle-left"></i>
                </p>
            </a>
            <ul class="nav nav-treeview">
                @can('storeTypes.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('shop/storeTypes*') ? 'active' : '' }}" href="{!! route('storeTypes.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-list-alt"></i>
                            @endif<p>{{trans('shop::lang.store_type_plural')}}</p></a>
                    </li>
                @endcan
                @can('stores.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('shop/stores','shop/stores/') ? 'active' : '' }}" href="{!! route('stores.index') !!}">@if($icons)
                                <i class="nav-icon fa fa-list-alt"></i>
                            @endif<p>{{trans('shop::lang.store_plural')}}</p></a>
                    </li>
                @endcan
                @can('requestedStores.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('shop/requestedStores','shop/requestedStores/') ? 'active' : '' }}" href="{!! route('requestedStores.index') !!}">@if($icons)
                                <i class="nav-icon fa fa-list-alt"></i>
                            @endif<p>{{trans('shop::lang.requested_store_plural')}}</p></a>
                    </li>
                @endcan
                @can('addresses.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('shop/addresses*') ? 'active' : '' }}" href="{!! route('addresses.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-map-marked-alt"></i>
                            @endif<p>{{trans('lang.address_plural')}}</p></a>
                    </li>
                @endcan
                @can('shopEarnings.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('shop/shopEarnings*') ? 'active' : '' }}" href="{!! route('shopEarnings.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-money-bill"></i>
                            @endif<p>{{trans('shop::lang.shop_earning_plural')}}  </p></a>
                    </li>
                @endcan
                @can('storePayouts.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('shop/storePayouts*') ? 'active' : '' }}" href="{!! route('storePayouts.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-money-bill-wave"></i>
                            @endif<p>{{trans('shop::lang.store_payout_plural')}}</p></a>
                    </li>
                @endcan
    ...
    @can('shopCategories.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('shop/shopCategories*') ? 'active' : '' }}" href="{!! route('shopCategories.index') !!}">@if($icons)
                    <i class="nav-icon fas fa-folder-open"></i>
                @endif<p>{{trans('shop::lang.shop_category_plural')}}</p></a>
        </li>
    @endcan
    @can('products.index')
        <li class="nav-item has-treeview {{ Request::is('shop/product*') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{  Request::is('shop/product*') ? 'active' : '' }}"> @if($icons)
                    <i class="nav-icon fas fa-pencil-ruler"></i>
                @endif
                <p>{{trans('shop::lang.product_plural')}} <i class="right fas fa-angle-left"></i>
                </p>
            </a>
            <ul class="nav nav-treeview">
                @can('products.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('shop/products*') ? 'active' : '' }}" href="{!! route('products.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-list"></i>
                            @endif
                            <p>{{trans('shop::lang.product_table')}}</p></a>
                    </li>
                @endcan
                @can('optionGroups.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('shop/productOptionGroups*') ? 'active' : '' }}" href="{!! route('productOptionGroups.index') !!}">@if($icons)
                                <i class="nav-icon fas fa-plus-square"></i>
                            @endif<p>{{trans('shop::lang.product_option_group_plural')}}</p></a>
                    </li>
                @endcan
                @can('options.index')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('shop/productOptions*') ? 'active' : '' }}" href="{!! route('productOptions.index') !!}">@if($icons)
                                <i class="nav-icon far fa-plus-square"></i>
                            @endif<p>{{trans('shop::lang.product_option_plural')}}</p></a>
                    </li>
                @endcan
    ...
    @endcan
    @can('orders.index')
    <li class="nav-item has-treeview {{ Request::is('shop/order*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('shop/order*')? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fas fa-calendar-check"></i>
            @endif
            <p>{{trans('shop::lang.order_plural')}} <i class="right fas fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            ...
            @can('orders.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('shop/orders*') ? 'active' : '' }}" href="{!! route('orders.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-calendar-check"></i>
                        @endif<p>{{trans('shop::lang.order_plural')}}</p></a>
                </li>
            @endcan
            @can('orderStatuses.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('shop/orderStatuses*') ? 'active' : '' }}" href="{!! route('orderStatuses.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-server"></i>
                        @endif<p>{{trans('shop::lang.order_status_plural')}}</p></a>
                </li>
            @endcan
    ...
    @can('eProviderSubscriptions.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('eProviderSubscriptions*') ? 'active' : '' }}" href="{!! route('eProviderSubscriptions.index') !!}">@if($icons)
                ...
                @endif<p>{{trans('subscription::lang.e_provider_subscription_plural')}}@if (config('installer.demo_app'))
            ...
            @can('payments.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('payments*') ? 'active' : '' }}" href="{!! route('payments.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-money-check-alt"></i>
                        @endif<p>{{trans('lang.payment_table')}}</p></a>
                </li>
            @endcan
            @can('paymentMethods.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('paymentMethods*') ? 'active' : '' }}" href="{!! route('paymentMethods.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.payment_method_plural')}}</p></a>
                </li>
            @endcan
            ...
            @can('paymentStatuses.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('paymentStatuses*') ? 'active' : '' }}" href="{!! route('paymentStatuses.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.payment_status_plural')}}</p></a>
                </li>
            @endcan
            ...
            @can('eProviderPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('eProviderPayouts*') ? 'active' : '' }}" href="{!! route('eProviderPayouts.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-money-bill-wave"></i>
                        @endif<p>{{trans('lang.e_provider_payout_plural')}}</p></a>
                </li>
            @endcan
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
                <a class="nav-link {{ Request::is('wallets*') ? 'active' : '' }}" href="{!! route('wallets.index') !!}">@if($icons)
                    ...
                    @endif<p>{{trans('lang.wallet_table')}}</p></a>
            </li>
            @can('walletTransactions.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('walletTransactions*') ? 'active' : '' }}" href="{!! route('walletTransactions.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-list-alt"></i>
                        @endif<p>{{trans('lang.wallet_transaction_plural')}}</p></a>
                </li>
            @endcan
...
@can('earnings.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('earnings*') ? 'active' : '' }}" href="{!! route('earnings.index') !!}">@if($icons)
                <i class="nav-icon fas fa-money-bill"></i>
            @endif<p>{{trans('lang.earning_plural')}}  </p></a>
    </li>
@endcan
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="{!! url('settings/mobile/globals') !!}" class="nav-link {{  Request::is('settings/mobile/globals*') ? 'active' : '' }}">
                    ...
                    @endif <p>{{trans('lang.app_setting_globals')}}
                    </p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{!! url('settings/mobile/colors') !!}" class="nav-link {{  Request::is('settings/mobile/colors*') ? 'active' : '' }}">
                    ...
                    @endif <p>{{trans('lang.mobile_colors')}}
                    </p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{!! url('settings/mobile/authentication') !!}" class="nav-link {{  Request::is('settings/mobile/authentication*') ? 'active' : '' }}">
                    ...
                    @endif <p>{{trans('lang.app_setting_authentication')}}
                    </p>
                </a>
            </li>
            ...
            @can('customPages.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('customPages*') ? 'active' : '' }}" href="{!! route('customPages.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.custom_page_plural')}}</p></a>
                </li>
            @endcan
            ...
            @can('slides.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('slides*') ? 'active' : '' }}" href="{!! route('slides.index') !!}">@if($icons)
                        ...
                        @endif<p>{{trans('lang.slide_plural')}} </p>
                    </a>
                </li>
            @endcan
        </ul>
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="{!! url('settings/app/globals') !!}" class="nav-link {{  Request::is('settings/app/globals*') ? 'active' : '' }}">
                    @if($icons)
                        <i class="nav-icon fas fa-cog"></i>
                    @endif <p>{{trans('lang.app_setting_globals')}}</p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('settings/customFields*') ? 'active' : '' }}" href="{!! route('customFields.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-list"></i>
                    @endif<p>{{trans('lang.custom_field_plural')}}</p></a>
            </li>
            ...
            <li class="nav-item">
                <a href="{!! url('settings/payment/payment') !!}" class="nav-link {{  Request::is('settings/payment*') ? 'active' : '' }}">
                    @if($icons)
                        <i class="nav-icon fas fa-credit-card"></i>
                    @endif <p>{{trans('lang.app_setting_payment')}}</p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{!! url('settings/app/social') !!}" class="nav-link {{  Request::is('settings/app/social*') ? 'active' : '' }}">
                    ...
                    @endif <p>{{trans('lang.app_setting_social')}}</p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{!! url('settings/app/notifications') !!}" class="nav-link {{  Request::is('settings/app/notifications*') ? 'active' : '' }}">
                    @if($icons)
                        <i class="nav-icon fas fa-bell"></i>
                    @endif <p>{{trans('lang.app_setting_notifications')}}</p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{!! url('settings/mail/smtp') !!}" class="nav-link {{ Request::is('settings/mail*') ? 'active' : '' }}">
                    ...
                    @endif <p>{{trans('lang.app_setting_mail')}}</p>
                </a>
            </li>
